...
# nri.io/nri-plugins-unified-operator-bundle:$VERSION and nri.io/nri-plugins-unified-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= nri.io/nri-plugins-unified-operator
